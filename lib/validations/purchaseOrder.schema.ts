...
export const purchaseOrderSignatureCaptureSchema = z.object({
...
export const receivePurchaseOrderSchema = purchaseOrderSignatureCaptureSchema.extend({
  items: z.array(
    z.object({
...
export const signPurchaseOrderSchema = purchaseOrderSignatureCaptureSchema.extend({
