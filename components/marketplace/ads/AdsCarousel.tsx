...
export function AdsCarousel({ initialAds }: AdsCarouselProps) {
  ...
  return (
    <section
      ...
      className="rounded-[10px] border border-white/60 bg-white/35 p-5 shadow-[0_18px_60px_rgba(70,90,58,0.16)] backdrop-blur-xl sm:p-7"
    >
      <div className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <h2 className="mt-2 font-[family-name:var(--font-yellowtail)] text-2xl font-normal tracking-tight text-[#3c2e60]">
            Handpicked for you
          </h2>
        </div>
      ...
      >
        {initialAds.map((ad) => (
          <button
            ...
            className="group relative w-72 flex-shrink-0 snap-start overflow-hidden rounded-[10px] border border-white/65 bg-white/50 text-left shadow-[0_14px_40px_rgba(70,90,58,0.14)] backdrop-blur transition duration-200 hover:-translate-y-1 hover:shadow-[0_20px_55px_rgba(70,90,58,0.2)]"
          >
